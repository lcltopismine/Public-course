/*
 ...
 Run execultion time for series algo, exe time for p threads.
 Run time: O(N/p+log p)
 P VS speed_up >> inverese U
 where speed_up = T(p(1))/T(p(n_core))
